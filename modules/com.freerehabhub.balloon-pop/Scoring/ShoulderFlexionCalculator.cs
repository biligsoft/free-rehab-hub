...
// arm-raise'deki aynı isimli sınıfın kasıtlı bir kopyası, cross-module bağımlılık yerine
// (bkz. module-development skill § 3a — her modül core'a/başka bir modüle dokunmadan
// bağımsız eklenip kaldırılabilmeli). Omuz fleksiyon açısını hesaplar: kalça->omuz vektörüne
// göre omuz->dirsek vektörünün açısı. 0° kol gövdenin yanında sarkarken, ~90° kol yatayken,
// ~180° kol tam kaldırılmışken.
